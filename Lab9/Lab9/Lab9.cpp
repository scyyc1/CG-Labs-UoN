...
float vertices[] =
{
	//back face
	//pos					//col				//normal
	-0.5f, -0.5f, -0.5f,  	0.f, 0.0f, 1.0f,	0.f,0.f,-1.f,
	0.5f, -0.5f, -0.5f,  	0.f, 0.0f, 1.0f,	0.f,0.f,-1.f,
	0.5f,  0.5f, -0.5f,  	0.f, 0.0f, 1.0f,	0.f,0.f,-1.f,
	0.5f,  0.5f, -0.5f,  	0.f, 0.0f, 1.0f,	0.f,0.f,-1.f,
	-0.5f,  0.5f, -0.5f,  	0.f, 0.0f, 1.0f,	0.f,0.f,-1.f,
	...
	//left face
	-0.5f,  0.5f,  0.5f,  	0.f, 0.0f, 1.0f,	-1.f,0.f,0.f,
	-0.5f,  0.5f, -0.5f,  	0.f, 0.0f, 1.0f,	-1.f,0.f,0.f,
	-0.5f, -0.5f, -0.5f,  	0.f, 0.0f, 1.0f,	-1.f,0.f,0.f,
	-0.5f, -0.5f, -0.5f,  	0.f, 0.0f, 1.0f,	-1.f,0.f,0.f,
	-0.5f, -0.5f,  0.5f,  	0.f, 0.0f, 1.0f,	-1.f,0.f,0.f,
	...
	//bottom face
	-0.5f, -0.5f, -0.5f,  	0.f, 0.0f, 1.0f,	0.f,-1.f,0.f,
	0.5f, -0.5f, -0.5f,  	0.f, 0.0f, 1.0f,	0.f,-1.f,0.f,
	0.5f, -0.5f,  0.5f,  	0.f, 0.0f, 1.0f,	0.f,-1.f,0.f,
	0.5f, -0.5f,  0.5f,  	0.f, 0.0f, 1.0f,	0.f,-1.f,0.f,
	-0.5f, -0.5f,  0.5f,  	0.f, 0.0f, 1.0f,	0.f,-1.f,0.f,
...
int main(int argc, char** argv)
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(shaderProgram, "DiretionaLightDir"), 0.f, -1.f, 0.f);
		glUniform3f(glGetUniformLocation(shaderProgram, "lightDirection"), lightDirection.x, lightDirection.y, lightDirection.z);
		glUniform3f(glGetUniformLocation(shaderProgram, "lightColour"), 0.5f, 0.5f, 0.5f);
